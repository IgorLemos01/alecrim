...
> Exercício acadêmico de adaptação arquitetural: o mesmo sistema de gestão de biblioteca, primeiro em arquitetura em camadas (MVC/Service) e depois parcialmente migrado para Clean Architecture.
...
Não é necessário configurar um banco de dados: o projeto usa EF Core InMemory, então os dados são recriados a cada execução.
